...
(function () {
    ...
    App.MenuResponsive = {
        ...
        listenToCloseEvent: function listenToCloseEvent() {
            var _this = this;
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                if (typeof ga !== 'undefined') {
                    ga('send', 'event', _this.options.conversionCategory, _this.options.conversionAction, _this.options.conversionLabel);
                }
...
App.Messages = {
    errors: function errors(messages) {
        var msg = [];
    ...
    message: function message(_message, title) {
...
var _handleButton$handleConfirm$handleCancel = __webpack_require__(12);

var _handleKeyDown = __webpack_require__(13);
